...
// ----------------------------------------------------------------
// Same-word-size AND operator (ComBitBtv)
// ----------------------------------------------------------------

/// Same-word-size AND operator.  Returns ComBitBtv<64>.
...
// cross_and explicit instantiations for all WordSize combinations:
#define INSTANTIATE_CROSS_AND(A, B) \
    template ComBitBtv<64> cross_and<A, B>(const ComBitBtv<A>&, const ComBitBtv<B>&);

INSTANTIATE_CROSS_AND(8, 8)
INSTANTIATE_CROSS_AND(8, 16)
INSTANTIATE_CROSS_AND(8, 32)
INSTANTIATE_CROSS_AND(8, 64)
INSTANTIATE_CROSS_AND(16, 8)
INSTANTIATE_CROSS_AND(16, 16)
INSTANTIATE_CROSS_AND(16, 32)
INSTANTIATE_CROSS_AND(16, 64)
INSTANTIATE_CROSS_AND(32, 8)
INSTANTIATE_CROSS_AND(32, 16)
INSTANTIATE_CROSS_AND(32, 32)
INSTANTIATE_CROSS_AND(32, 64)
INSTANTIATE_CROSS_AND(64, 8)
INSTANTIATE_CROSS_AND(64, 16)
INSTANTIATE_CROSS_AND(64, 32)
INSTANTIATE_CROSS_AND(64, 64)

#undef INSTANTIATE_CROSS_AND
