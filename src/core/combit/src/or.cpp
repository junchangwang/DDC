...
// ----------------------------------------------------------------
// Same-word-size OR operator (ComBitBtv)
// ----------------------------------------------------------------

/// Same-word-size OR operator.  Returns ComBitBtv<64>.
...
// cross_or explicit instantiations for all WordSize combinations:
#define INSTANTIATE_CROSS_OR(A, B) \
    template ComBitBtv<64> cross_or<A, B>(const ComBitBtv<A>&, const ComBitBtv<B>&);

INSTANTIATE_CROSS_OR(8, 8)
INSTANTIATE_CROSS_OR(8, 16)
INSTANTIATE_CROSS_OR(8, 32)
INSTANTIATE_CROSS_OR(8, 64)
INSTANTIATE_CROSS_OR(16, 8)
INSTANTIATE_CROSS_OR(16, 16)
INSTANTIATE_CROSS_OR(16, 32)
INSTANTIATE_CROSS_OR(16, 64)
INSTANTIATE_CROSS_OR(32, 8)
INSTANTIATE_CROSS_OR(32, 16)
INSTANTIATE_CROSS_OR(32, 32)
INSTANTIATE_CROSS_OR(32, 64)
INSTANTIATE_CROSS_OR(64, 8)
INSTANTIATE_CROSS_OR(64, 16)
INSTANTIATE_CROSS_OR(64, 32)
INSTANTIATE_CROSS_OR(64, 64)

#undef INSTANTIATE_CROSS_OR
