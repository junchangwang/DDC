 ...
 */
void DDCEncoder::flush_run(DDCEncoding& enc, uint8_t fill_bit_val, size_t run_length) {
    while (run_length > 0) {
...
DDCEncoding DDCEncoder::encode_words(const std::vector<Word>& words) {
    DDCEncoding enc;
...
DDCEncoding DDCEncoder::encode(const std::vector<bool>& bits) {
