...
struct CompressedDirInfo {
    ...
    std::string algo;
    // When the directory was generated by gen_bitmap -t <count_a> (transition
    // mode: 2 independent random bitmaps, count_a bits per 65 536-segment),
    // is_transition=true and cardinality holds count_a.
