// combit_only_compress.cpp - Regenerate only ComBit .bm files from raw bitmaps
#include <iostream>
#include <fstream>
#include <vector>
#include <string>
...
static void compress_one(const std::string& raw_path, const std::string& out_path, size_t total_rows) {
    ...
    // Convert raw bytes to vector<bool>
...
int main(int argc, char** argv) {
    ...
    std::string output_dir = "bitmap/tpch_q6_combit";
    ...
    std::cout << "ComBit-only compressor (L3 format)\n";
